  ...
  return (
    <>
      <div className="w-full h-full top-[124px] flex">
        ...
        <div>
          <div className="">
            <div className="screenLeft lg:w-[1000px] lg:h-full lg:flex flex-col">
              {/* Large Image */}
              <div className="flex flex-col lg:flex-row   p-6   rounded-lg">
                ...
                <div className="w-auto h-[408px] lg:ml-10 mt-20 lg:mt-0 lg:w-[492px] lg:h-auto bg-white shadow-md rounded-lg p-6">
                  {/* Title */}
            ...
            <div className="bg-white lg:w-[1016px] lg:h-auto w-auto h-auto ml-5 mt-[92px] rounded-lg shadow-md p-4 lg:p-10">
              {/* Header */}
            ...
            <div className=" flex gap-[100px] lg:gap-[860px]   w-auto lg:h-[44px] justify-center  ml-5  h-[20px] mt-10">
            ...
            <div className=" flex flex-wrap">
              {carData.slice(0, visibleCars).map((car) => (
                <div
                  key={car.id}
                  className="w-[304px] h-[408px] mt-10 lg:mt-0 ml-10 bg-white rounded-lg shadow-md p-4 flex flex-col"
                >
            ...
            <div className="flex  gap-[100px] lg:gap-[700px] lg:w-[1016px] lg:h-[44px] w-[327px] h-[20px] justify-center mt-10">
...
//   <div className="flex flex-col items-center  lg:items-start w-full lg:w-1/2">
//     {/* Large Image */}
//     <div className="w-auto  h-[232px] ml-4 lg:w-[492px] lg:h-[360px] mb-6">
//       <Image src={leftTopImg} alt="Large Car Image" className="w-full h-full object-cover rounded-lg" />
//     </div>
...
// <div className="flex  gap-[100px] lg:gap-[700px] lg:w-[1016px] lg:h-[44px] w-[327px] h-[20px] justify-center lg:ml-36 ml-10 mt-10">
// <p className="text-lablelTxt text-[16px]"><a href="/Home">Recent Car</a></p>
//          <p className="text-[16px] text-btnBg"><a href="/categories">View All</a></p>
// </div>
// <div className=" lg:flex   lg:ml-5 mr-5 justify-center items-center">
//           {carData.slice(0, visibleCars).map((car) => (
//             <div
//               key={car.id}
//               className="w-[304px] h-[408px] mt-10 lg:mt-0 lg:ml-20 ml-10 bg-white rounded-lg shadow-md p-4 flex flex-col"
//             >
//               <div className="flex justify-between items-center mb-4">
//                 <span className="text-lg font-bold w-full text-gray-800 flex flex-col">
//                   {car.name}
...
//          <p className="text-[16px] text-btnBg"><a href="/categories">View All</a></p>
// </div>
// <div className="lg:flex lg:flex-wrap lg:ml-4 mb-10  justify-center">

  
//           {carData2.slice(0, visibleCars).map((car) => (
//             <div
//               key={car.id}
//               className="w-[304px] h-[408px] bg-white rounded-lg mt-10  lg:ml-20 ml-10 shadow-md p-4 flex flex-col"
//             >
//               <div className="flex justify-between items-center mb-4">
//                 <span className="text-lg font-bold w-full text-gray-800 flex flex-col">
//                   {car.name}
